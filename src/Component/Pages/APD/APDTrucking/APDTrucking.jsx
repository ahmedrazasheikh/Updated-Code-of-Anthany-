...
import {  Box, Center, IconButton, InputLeftElement, Divider, InputGroup, Input, HStack, Heading, Text, Flex, Button, VStack, Image, AspectRatio } from '@chakra-ui/react';
import { useState } from 'react';
function APD() {

const [mgaFirstRadio  , setmgaFirstRadio] = useState(false)
const [isDisabled, setIsDisabled] = useState(true)
const [ApprovalRoo,setApprovalRoo ]  = useState(true)
const [ApprovalRooinput,setApprovalRooinput ]  = useState(false)
const [policyLocked , setPolicyLocked] = useState(false)   
const [RnQuote,  setRnQuote] = useState(false)
const[Submissionstatus, setSubmissionstatus] = useState()
const [Signedapplication ,  setSignedapplication  ] = useState(false)
const [Paymentrecived , setPaymentrecived] = useState()   
                ...
                <Flex h="" width='auto'>
                    ...
                    <Box flex="1" flex-direction='column'>
                        <VStack justifyContent='center' >
                            <Box    h="100%" width="100%" rounded='md' boxShadow='md' display='flex' alignItem='center' justifyContent='space-evenly'>
                                <Accordion allowToggle width={'100%'}>
                                        ...
                                        <AccordionPanel pb={4}>
                                            <HStack pb={4} borderBottom='1px' borderBottomColor='black.100' h='40%'>
                                                <Box borderRight='1px' borderRightColor='black.100' w='50%' h='90%' >
                                                    <HStack >
                                                        <RadioGroup         onChange={(e)=>{console.log(e)}}    defaultValue='1' w='50%'>
                                                            <Stack>
                                                                <Radio value='Decide Later'>Decide Later </Radio>
                                                                <Radio value='Approval by MGA'>Approval by MGA</Radio>
                                                                <Radio value='Reject Application'>Reject Application </Radio>
                                                            </Stack>
                                                        </RadioGroup>
                                                        ...
                                                        <RadioGroup         onChange={(e)=>{console.log(e)}}    defaultValue='1' w='50%'>
                                                            <Stack>
                                                                <Radio value='Approval Roo!'>     Approval Roo! </Radio>
                                                                <Radio value='Company Approval'>Company Approval</Radio>
                                                            </Stack>
                                                        </RadioGroup>                                                       
                                                            <Input  onChange={(e)=>console.log(ApprovalRooinput(e.target.value))}   borderRadius='5px' w='80%' size='sm' />
                                                        </Stack>
                                                    </HStack>
                                                ...
                                                <Box w='40%' h='90%' >
                                                    <HStack >
                                                        ...
                                                        <Stack spacing={5} w='70%' pt='20px' >
                                                            <Checkbox    onChange={(e)=> console.log(e)     }        colorScheme='blue' >
                                                                Policy Locked
                                                            </Checkbox>
                                                            <Text>MGA bind only !</Text>
                                                            <HStack><Text>RnQuote </Text> <Select  onChange={(e)=>console.log(e.target.value)   }    size='sm' borderRadius='5px'>
                                                                <option   value={"Let system decide"}>Let system decide</option>
                                                                <option   value={"Don't Send"}>Don't Send</option>
                                                                <option   value={"Send"}>Send </option>
                                                            </Select></HStack>
                                                            <HStack w='100%'><Text>Submission Status :</Text> 
                                                             <Select          onChange={(e)=>{console.log(e.target.value);}}    size='sm'    borderRadius='5px'>
                                                    ...
                                                    <VStack alignItems='flex-start'>
                                                        <HStack>
                                                            <Text w='420px'>Signed application recived (logs) </Text>
                                                                <HStack>
                                                            <RadioGroup       onChange={(e)=> {console.log(e)}     }  defaultValue='No'>
                                    ...
                                    <AccordionItem     isDisabled={true} mt="2%">
                                        <h2>
                                            <AccordionButton      _expanded={{ bg: 'blue', color: 'white' }}>
